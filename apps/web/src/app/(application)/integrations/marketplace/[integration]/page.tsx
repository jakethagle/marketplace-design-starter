...
export default async function ListingPage({
  ...
  const defaultIntegration = {
    ...
    price: "$220",
    description:
      `Elevate your business efficiency with our Advanced ${marketplaceListing.integration.name ?? "Salesforce"} Integration. This robust integration is designed to seamlessly connect ${marketplaceListing.integration.name ?? "Salesforce"} with your existing business applications, creating a unified and powerful system for managing customer relationships and streamlining processes`,
    highlights: [
