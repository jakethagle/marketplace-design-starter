...
export interface RootQuery {
     ...
     */
    onPremiseResource: (OnPremiseResource | null)
    /**
     * 
    ...
    componentActionSearchResults: (ComponentActionSearchResult | null)[]
    /**
     * 
...
export type Node = (OrgTotalUsageMetrics | OrgDailyUsageMetrics | InstanceDailyUsageMetrics | Instance | Customer | Organization | Theme | ThemeColor | ThemeProperty | OrganizationSigningKey | Credential | AuthorizationMethod | CredentialField | User | Role | AuthObjectType | Permission | Integration | InstanceProfile | RequiredConfigVariable | Connection | Component | Action | InputField | Version | ConnectionTemplate | InputFieldTemplate | RequiredConfigVariableCredentialType | Expression | IntegrationFlow | IntegrationAction | InstanceExecutionResult | InstanceFlowConfig | AlertMonitor | AlertTrigger | AlertGroup | AlertWebhook | AlertEvent | Log | InstanceConfigVariable | OnPremiseResource | UserLevelConfigVariable | UserLevelConfig | UserLevelFlowConfig | InstanceStepResult | CustomerTotalUsageMetrics | StarredRecord | ObjectPermissionGrant | ExternalLogStream | Label | IntegrationCategory | ComponentCategory | Activity) & { __isUnion?: true }
...
export interface Integration {
    ...
    versionAttributes: (Scalars['JSONString'] | null)
    ...
    defaultInstanceProfile: (InstanceProfile | null)
...
export interface Connection {
    ...
    onPremiseAvailable: Scalars['Boolean']
...
export interface InputField {
    ...
    onPremiseControlled: Scalars['Boolean']
...
/** An enumeration. */
export type RequiredConfigVariableOnPremiseConnectionConfig = 'REQUIRED' | 'ALLOWED' | 'DISALLOWED'
...
export interface OnPremiseResource {
    /** The ID of the object */
    id: Scalars['ID']
...
/** An enumeration. */
export type OnPremiseResourceStatus = 'PENDING' | 'AVAILABLE' | 'UNAVAILABLE' | 'UNKNOWN'
...
export interface OnPremiseResourceConnection {
    /** Pagination data for this connection. */
    pageInfo: PageInfo
    /** List of nodes in this connection. */
    nodes: (OnPremiseResource | null)[]
    /** List of edges containing the nodes in this connection. */
    edges: (OnPremiseResourceEdge | null)[]
    /** Total count of nodes available. */
    totalCount: Scalars['Int']
...
export interface OnPremiseResourceEdge {
    /** The related object at the end of the edge. */
    node: (OnPremiseResource | null)
    /** A cursor for use in pagination. */
    cursor: Scalars['String']
...
/** Represents the fields by which collections of the related type may be ordered. */
export type OnPremiseResourceOrderField = 'NAME' | 'CUSTOMER'
...
export interface InstanceProfileConnection {
    /** Pagination data for this connection. */
    pageInfo: PageInfo
    /** List of nodes in this connection. */
    nodes: (InstanceProfile | null)[]
    /** List of edges containing the nodes in this connection. */
    edges: (InstanceProfileEdge | null)[]
    /** Total count of nodes available. */
    totalCount: Scalars['Int']
...
export interface InstanceProfileEdge {
    /** The related object at the end of the edge. */
    node: (InstanceProfile | null)
    /** A cursor for use in pagination. */
    cursor: Scalars['String']
...
/** Represents the fields by which collections of the related type may be ordered. */
export type InstanceProfileOrderField = 'NAME' | 'DESCRIPTION' | 'IS_DEFAULT_PROFILE'


/** Represents search results for a Component or Action. */
export type ComponentActionSearchResult = (Component | Action) & { __isUnion?: true }
...
export interface RootMutation {
     ...
     *     4. The signed-in User has any of the following permissions for the object's 'customer' attribute: [customer_admin_users, customer_view_users].
     */
    findUserByEmail: (FindUserByEmailPayload | null)
    /**
     *     
     ...
     *     1. The signed-in User has any of the following permissions for the object: [org_admin_users].
     */
    setOrganizationSalesforceId: (SetOrganizationSalesforceIdPayload | null)
    /**
     *     
     ...
     *     2. The specified object is the signed-in User.
     */
    updateUserLevelOAuth2Connection: (UpdateUserLevelOAuth2ConnectionPayload | null)
    /**
     ...
     *     1. The signed-in User has any of the following permissions for the associated Organization: [org_manage_instances].
     */
    createInstanceProfile: (CreateInstanceProfilePayload | null)
    /**
     ...
     *     1. The signed-in User has any of the following permissions for the associated Organization: [org_manage_instances].
     */
    deleteInstanceProfile: (DeleteInstanceProfilePayload | null)
    /**
     *     
     *     Deploys an Instance.
     *     
     ...
     *     1. The signed-in User has any of the following permissions for the associated Organization: [org_manage_instances].
     */
    updateInstanceProfile: (UpdateInstanceProfilePayload | null)
    /**
     *     
     ...
     *     3. The signed-in User has any of the following permissions for the object's 'customer' attribute: [customer_admin_integration_permissions, customer_manage_integrations, customer_view_integrations].
     */
    updateIntegrationTestConfiguration: (UpdateIntegrationTestConfigurationPayload | null)
    /**
     *     
     ...
     */
    createOnPremiseResourceJWT: (CreateOnPremiseResourceJWTPayload | null)
    /**
     ...
     */
    deleteOnPremiseResource: (DeleteOnPremiseResourcePayload | null)
    /**
     *     
     ...
     *     2. The signed-in User has any of the following permissions for the access function context object 'customer': [customer_edit] when 'customer' is provided in the access function context.
     */
    rotateOnPremiseResourceJWT: (RotateOnPremiseResourceJWTPayload | null)
    /**
     *     
...
export interface OrganizationReturnObject {
    ...
    orgName: (Scalars['String'] | null)
    salesforceId: (Scalars['String'] | null)
    ...
    allowConfiguringInstanceMemory: (Scalars['Boolean'] | null)
    allowOnPremAgent: (Scalars['Boolean'] | null)
...
export interface SetOrganizationSalesforceIdPayload {
    result: (AdminOperationResult | null)
    errors: ErrorType[]
    clientMutationId: (Scalars['String'] | null)
...
export interface UpdateUserLevelOAuth2ConnectionPayload {
    userLevelConfigVariable: (UserLevelConfigVariable | null)
    errors: ErrorType[]
    clientMutationId: (Scalars['String'] | null)
...
export interface CreateInstanceProfilePayload {
    instanceProfile: (InstanceProfile | null)
    errors: ErrorType[]
    clientMutationId: (Scalars['String'] | null)
...
export interface DeleteInstanceProfilePayload {
    instanceProfile: (InstanceProfile | null)
    errors: ErrorType[]
    clientMutationId: (Scalars['String'] | null)
...
export interface UpdateInstanceProfilePayload {
    instanceProfile: (InstanceProfile | null)
    errors: ErrorType[]
    clientMutationId: (Scalars['String'] | null)
...
export interface UpdateIntegrationTestConfigurationPayload {
    integration: (Integration | null)
    errors: ErrorType[]
    clientMutationId: (Scalars['String'] | null)
...
export interface CreateOnPremiseResourceJWTPayload {
    result: (CreateOnPremiseResourceJWTResult | null)
    errors: ErrorType[]
    clientMutationId: (Scalars['String'] | null)
    __typename: 'CreateOnPremiseResourceJWTPayload'
}

export interface CreateOnPremiseResourceJWTResult {
    jwt: (Scalars['String'] | null)
    __typename: 'CreateOnPremiseResourceJWTResult'
}

export interface DeleteOnPremiseResourcePayload {
    onPremiseResource: (OnPremiseResource | null)
    errors: ErrorType[]
    clientMutationId: (Scalars['String'] | null)
...
export interface RotateOnPremiseResourceJWTPayload {
    result: (CreateOnPremiseResourceJWTResult | null)
    errors: ErrorType[]
    clientMutationId: (Scalars['String'] | null)
...
export interface RootQueryGenqlSelection{
     ...
     *     2. The signed-in User has any of the following permissions for the object's 'customer' attribute: [customer_view, customer_edit, customer_remove, customer_admin_users, customer_view_users, customer_admin_instance_permissions, customer_view_instances, customer_manage_marketplace_integrations, customer_access_marketplace_integrations].
     */
    onPremiseResource?: (OnPremiseResourceGenqlSelection & { __args: {
     ...
     *     2. The signed-in User has any of the following permissions for the object's 'customer' attribute: [customer_view, customer_edit, customer_remove, customer_admin_users, customer_view_users, customer_admin_instance_permissions, customer_view_instances, customer_manage_marketplace_integrations, customer_access_marketplace_integrations].
     */
    onPremiseResources?: (OnPremiseResourceConnectionGenqlSelection & { __args?: {
    /** Specifies a cursor for use in combination with `last` to implement backward pagination. */
    before?: (Scalars['String'] | null), 
    /** Specifies a cursor for use in combination with `first` to implement forward pagination. */
    after?: (Scalars['String'] | null), 
    ...
    /** DEPRECATED. Prefer using sort_by instead as it allows ordering by many fields. */
    orderBy?: (OnPremiseResourceOrder | null), 
    /** Allows specifying many field and direction pairs to sort results by. */
    sortBy?: ((OnPremiseResourceOrder | null)[] | null)} })
    /**
     * 
     *     Returns the specified Integration object.
     * 
    ...
    labels_Contains?: (Scalars['String'] | null), 
    /** DEPRECATED. Prefer using sort_by instead as it allows ordering by many fields. */
    ...
    /** Returns a list of Integration categories. */
    integrationCategories?: (IntegrationCategoryGenqlSelection & { __args?: {
    /** Only include categories that appear on the latest versions of Integrations. */
    onlyLatest?: (Scalars['Boolean'] | null), 
     ...
     *     1. The signed-in User has any of the following permissions for the associated Organization: [org_admin_instance_permissions, org_manage_instances, org_view_instances].
     */
    instanceProfile?: (InstanceProfileGenqlSelection & { __args: {
     ...
     *     1. The signed-in User has any of the following permissions for the associated Organization: [org_admin_instance_permissions, org_manage_instances, org_view_instances].
     */
    instanceProfiles?: (InstanceProfileConnectionGenqlSelection & { __args?: {
    /** Specifies a cursor for use in combination with `last` to implement backward pagination. */
    before?: (Scalars['String'] | null), 
    /** Specifies a cursor for use in combination with `first` to implement forward pagination. */
    after?: (Scalars['String'] | null), 
    ...
    isDefaultProfile?: (Scalars['Boolean'] | null), 
    /** DEPRECATED. Prefer using sort_by instead as it allows ordering by many fields. */
    orderBy?: (InstanceProfileOrder | null), 
    /** Allows specifying many field and direction pairs to sort results by. */
    sortBy?: ((InstanceProfileOrder | null)[] | null)} })
    /** Returns a list of unique Instance labels. */
    ...
    id?: (Scalars['ID'] | null), id_In?: ((Scalars['ID'] | null)[] | null), 
    /** The status of the Instance execution. */
    ...
    /** Returns a list of Components and Actions that match the search criteria. */
    componentActionSearchResults?: (ComponentActionSearchResultGenqlSelection & { __args: {
    ...
    orgUsers?: (UserGenqlSelection & { __args: {
    ...
    timestamp_Gt?: (Scalars['DateTime'] | null), 
    /** Filter for objects where timestamp.lt matches the specified value. */
    timestamp_Lt?: (Scalars['DateTime'] | null), 
    /** Filter for objects where timestamp occurs on or after the specified value. */
    timestamp_Gte?: (Scalars['DateTime'] | null), 
    /** Filter for objects where timestamp occurs on or before the specified value. */
    timestamp_Lte?: (Scalars['DateTime'] | null), 
...
export interface NodeGenqlSelection{
    ...
    on_InstanceProfile?: InstanceProfileGenqlSelection
    ...
    on_OnPremiseResource?: OnPremiseResourceGenqlSelection
...
export interface InstanceGenqlSelection{
    ...
    /** The Instance Profile used by this Instance. */
    profile?: InstanceProfileGenqlSelection
    /** The Instance that is being monitored by the AlertMonitor. */
...
export interface OrganizationGenqlSelection{
    ...
    /** Specifies whether this Plan allows for configuring the memory allocated to the Runner Lambda functions. */
    allowConfiguringInstanceMemory?: boolean | number
    /** Specifies whether this Plan allows for using the On Prem Agent system. */
    allowOnPremAgent?: boolean | number
    /** This field has been deprecated. */
    overdue?: boolean | number
    /** The available billing types for Instances in the Organization. */
    instanceBillingTypes?: boolean | number
    /** Specifies whether the signed-in User can update the Organization. */
    allowUpdate?: boolean | number
    /** Specifies whether the signed-in User can remove the Organization. */
    allowRemove?: boolean | number
...
export interface IntegrationGenqlSelection{
    ...
    /** Additional attributes that are specific to this version. */
    versionAttributes?: boolean | number
    /** The name of the Integration. */
    name?: boolean | number
    /** Additional notes about the Integration. */
    description?: boolean | number
    ...
    /** The Instance Profile to use as a default when Instances of this Integration are created. */
    defaultInstanceProfile?: InstanceProfileGenqlSelection
 ...
 * and billing properties of an Instance.
 */
export interface InstanceProfileGenqlSelection{
    /** The ID of the object */
    id?: boolean | number
    /** The name of the Instance Profile, which must be unique within the scope of its Organization. */
    name?: boolean | number
    ...
    description?: boolean | number
    /** Specifies whether this Instance Profile is the default used when no Instance Profile is explicitly specified during Instance creation. */
    isDefaultProfile?: boolean | number
    /** Specifies whether to disable the creation of logs during Instance execution. */
    logsDisabled?: boolean | number
    /** Specifies whether to disable the creation of step results during Instance execution. */
    stepResultsDisabled?: boolean | number
    ...
    /** The billing type for the Instances that use this Instance Profile. */
    instanceBillingType?: boolean | number
    /** Specifies whether the signed-in User can update the InstanceProfile. */
    allowUpdate?: boolean | number
    /** Specifies whether the signed-in User can remove the InstanceProfile. */
    allowRemove?: boolean | number
...
export interface RequiredConfigVariableGenqlSelection{
    ...
    userLevelConfigured?: boolean | number
    /** Specifies the configuration for this Required Config Variable with respect to using an On-Prem Resource connection. */
    onPremiseConnectionConfig?: boolean | number
    /** The Required Config Var for which the Authorization Method is a valid type of Credential. */
...
export interface ConnectionGenqlSelection{
    ...
    /** If true, this connection can be used with an On-Prem Resource. */
    onPremiseAvailable?: boolean | number
    /** The Connection to which this InputField is associated, if any. */
...
export interface InputFieldGenqlSelection{
    ...
    /** If true, this input is controlled by the On-Prem Resource. */
    onPremiseControlled?: boolean | number
    /** Language to use for the Code Field. */
...
export interface InstanceConfigVariableGenqlSelection{
    ...
    meta?: boolean | number
    /** The On-Prem Resource that is associated with the Config Variable. */
    onPremiseResource?: OnPremiseResourceGenqlSelection
    /** The InstanceConfigVariable which relates to the Log entry. */
    logs?: (LogConnectionGenqlSelection & { __args?: {
    /** Filter for objects where executionResult.isTestExecution matches the specified value. */
    executionResult_IsTestExecution?: (Scalars['Boolean'] | null), 
...
/** Represents configuration for an On-Prem Resource. */
export interface OnPremiseResourceGenqlSelection{
    /** The ID of the object */
    id?: boolean | number
    /** The Customer associated with this resource. */
    customer?: CustomerGenqlSelection
...
export interface InstanceStepResultGenqlSelection{
    ...
    fromPreprocessFlow?: boolean | number
    /** A JSON value that contains attributes which uniquely identify the Component Action which generated this result. */
    componentActionKey?: boolean | number
    /** The presigned URL to download the result of this specific step of the Instance execution. */
...
/** Represents a Relay Connection to a collection of OnPremiseResource objects. */
export interface OnPremiseResourceConnectionGenqlSelection{
    /** Pagination data for this connection. */
    pageInfo?: PageInfoGenqlSelection
    /** List of nodes in this connection. */
    nodes?: OnPremiseResourceGenqlSelection
    /** List of edges containing the nodes in this connection. */
    edges?: OnPremiseResourceEdgeGenqlSelection
    /** Total count of nodes available. */
    totalCount?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** A Relay edge to a related OnPremiseResource object and a cursor for pagination. */
export interface OnPremiseResourceEdgeGenqlSelection{
    /** The related object at the end of the edge. */
    node?: OnPremiseResourceGenqlSelection
    /** A cursor for use in pagination. */
    cursor?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** Allows specifying which field and direction to order by. */
export interface OnPremiseResourceOrder {
/** The direction to order by. */
direction: OrderDirection,
/** The field to order by. */
...
/** Represents a Relay Connection to a collection of InstanceProfile objects. */
export interface InstanceProfileConnectionGenqlSelection{
    /** Pagination data for this connection. */
    pageInfo?: PageInfoGenqlSelection
    /** List of nodes in this connection. */
    nodes?: InstanceProfileGenqlSelection
    /** List of edges containing the nodes in this connection. */
    edges?: InstanceProfileEdgeGenqlSelection
    /** Total count of nodes available. */
    totalCount?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** A Relay edge to a related InstanceProfile object and a cursor for pagination. */
export interface InstanceProfileEdgeGenqlSelection{
    /** The related object at the end of the edge. */
    node?: InstanceProfileGenqlSelection
    /** A cursor for use in pagination. */
    cursor?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** Allows specifying which field and direction to order by. */
export interface InstanceProfileOrder {
/** The direction to order by. */
direction: OrderDirection,
/** The field to order by. */
...
/** Represents search results for a Component or Action. */
export interface ComponentActionSearchResultGenqlSelection{
    on_Component?:ComponentGenqlSelection,
    on_Action?:ActionGenqlSelection,
...
export interface RootMutationGenqlSelection{
     ...
     *     4. The signed-in User has any of the following permissions for the object's 'customer' attribute: [customer_admin_users, customer_view_users].
     */
    findUserByEmail?: (FindUserByEmailPayloadGenqlSelection & { __args: {input: FindUserByEmailInput} })
    /**
     *     
     *     Promote a user to be an Organization Owner.
     *     
     ...
     *     1. The signed-in User has any of the following permissions for the object: [org_admin_users].
     */
    setOrganizationSalesforceId?: (SetOrganizationSalesforceIdPayloadGenqlSelection & { __args: {input: SetOrganizationSalesforceIdInput} })
    /**
     *     
     *     Enable or disable features for a specified Organization's plan.
     *     
     ...
     *     2. The specified object is the signed-in User.
     */
    updateUserLevelOAuth2Connection?: (UpdateUserLevelOAuth2ConnectionPayloadGenqlSelection & { __args: {input: UpdateUserLevelOAuth2ConnectionInput} })
    /**
     *     Creates a new ConnectionTemplate object.
     * 
     * Access is permitted when any of the following condition(s) are met:
     ...
     *     1. The signed-in User has any of the following permissions for the associated Organization: [org_manage_instances].
     */
    createInstanceProfile?: (CreateInstanceProfilePayloadGenqlSelection & { __args: {input: CreateInstanceProfileInput} })
    /**
     *     Removes the specified Instance object.
     * 
     * Access is permitted when any of the following condition(s) are met:
     ...
     *     1. The signed-in User has any of the following permissions for the associated Organization: [org_manage_instances].
     */
    deleteInstanceProfile?: (DeleteInstanceProfilePayloadGenqlSelection & { __args: {input: DeleteInstanceProfileInput} })
    /**
     *     
     *     Deploys an Instance.
     *     
     ...
     *     1. The signed-in User has any of the following permissions for the associated Organization: [org_manage_instances].
     */
    updateInstanceProfile?: (UpdateInstanceProfilePayloadGenqlSelection & { __args: {input: UpdateInstanceProfileInput} })
    /**
     *     
     *     Updates all Instances that reference the specified Integration to the
     *     latest published version of the specified Integration. If the Instances
     ...
     *     3. The signed-in User has any of the following permissions for the object's 'customer' attribute: [customer_admin_integration_permissions, customer_manage_integrations, customer_view_integrations].
     */
    updateIntegrationTestConfiguration?: (UpdateIntegrationTestConfigurationPayloadGenqlSelection & { __args: {input: UpdateIntegrationTestConfigurationInput} })
    /**
     *     
     *     Updates the availability of an Integration version.
     *     
     ...
     *     2. The signed-in User has any of the following permissions for the access function context object 'customer': [customer_edit] when 'customer' is provided in the access function context.
     */
    createOnPremiseResourceJWT?: (CreateOnPremiseResourceJWTPayloadGenqlSelection & { __args: {input: CreateOnPremiseResourceJWTInput} })
    /**
     *     Removes the specified OnPremiseResource object.
     * 
     * Access is permitted when any of the following condition(s) are met:
     ...
     *     2. The signed-in User has any of the following permissions for the object's 'customer' attribute: [customer_remove].
     */
    deleteOnPremiseResource?: (DeleteOnPremiseResourcePayloadGenqlSelection & { __args: {input: DeleteOnPremiseResourceInput} })
    /**
     *     
     *     Rotates the identity_key of an On-Prem Resource and returns a new JWT.
     *     
     ...
     *     2. The signed-in User has any of the following permissions for the access function context object 'customer': [customer_edit] when 'customer' is provided in the access function context.
     */
    rotateOnPremiseResourceJWT?: (RotateOnPremiseResourceJWTPayloadGenqlSelection & { __args: {input: RotateOnPremiseResourceJWTInput} })
    /**
     *     
     *     Creates a Signing Key for the Organization of the signed-in User.
     *     
...
export interface FindUserByEmailPayloadGenqlSelection{
    result?: FindUserResultGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
export interface FindUserResultGenqlSelection{
...
export interface SetOrganizationSalesforceIdPayloadGenqlSelection{
    result?: AdminOperationResultGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
...
export interface SetOrganizationSalesforceIdInput {
/** Global ID of Organization for which to set the specified Plan. */
orgId: Scalars['ID'],
/** The ID that is used to link one or more Organization(s) to an account in Salesforce. */
...
allowOnPremAgent?: (Scalars['Boolean'] | null),
/** Specifies the available choices to use for Instance billing. */
instanceBillingTypes?: ((Scalars['String'] | null)[] | null),
/** A unique identifier for the client performing the mutation. */
clientMutationId?: (Scalars['String'] | null)}
...
onPremiseControlled?: (Scalars['Boolean'] | null)}
...
export interface UpdateUserLevelOAuth2ConnectionPayloadGenqlSelection{
    userLevelConfigVariable?: UserLevelConfigVariableGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
...
export interface UpdateUserLevelOAuth2ConnectionInput {
/** The timestamp at which the next refresh attempt will occur for the Connection. */
refreshAt?: (Scalars['DateTime'] | null),
/** The OAuth2 access token to use for the Connection. */
accessToken?: (Scalars['String'] | null),
...
timeZone?: (Scalars['String'] | null),onPremiseResourceId?: (Scalars['ID'] | null)}
...
export interface CreateInstanceProfilePayloadGenqlSelection{
    instanceProfile?: InstanceProfileGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
export interface DeleteInstanceProfilePayloadGenqlSelection{
    instanceProfile?: InstanceProfileGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
...
export interface UpdateInstanceProfilePayloadGenqlSelection{
    instanceProfile?: InstanceProfileGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
...
allocatedMemoryMb?: (Scalars['Int'] | null),
/** The billing type for the Instances that use this Instance Profile. */
instanceBillingType?: (Scalars['String'] | null),
/** The ID of the InstanceProfile to mutate. */
id?: (Scalars['ID'] | null),
/** A unique identifier for the client performing the mutation. */
clientMutationId?: (Scalars['String'] | null)}
...
export interface UpdateIntegrationTestConfigurationPayloadGenqlSelection{
    integration?: IntegrationGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
...
export interface UpdateIntegrationTestConfigurationInput {
/** Data payload for testing the endpoint configuration for this Integration. */
endpointConfigTestPayload?: (Scalars['String'] | null),
/** Content type of the payload for testing the endpoint configuration for this Integration. */
endpointConfigTestContentType?: (Scalars['String'] | null),
...
export interface CreateOnPremiseResourceJWTPayloadGenqlSelection{
    result?: CreateOnPremiseResourceJWTResultGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
export interface CreateOnPremiseResourceJWTResultGenqlSelection{
    jwt?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface CreateOnPremiseResourceJWTInput {
/** The Customer associated with this resource. */
...
export interface DeleteOnPremiseResourcePayloadGenqlSelection{
    onPremiseResource?: OnPremiseResourceGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
...
export interface DeleteOnPremiseResourceInput {
/** The ID of the OnPremiseResource to mutate. */
id?: (Scalars['ID'] | null),
/** A unique identifier for the client performing the mutation. */
clientMutationId?: (Scalars['String'] | null)}

export interface RotateOnPremiseResourceJWTPayloadGenqlSelection{
    result?: CreateOnPremiseResourceJWTResultGenqlSelection
    errors?: ErrorTypeGenqlSelection
    clientMutationId?: boolean | number
    __typename?: boolean | number
...
export interface RotateOnPremiseResourceJWTInput {
/** The Customer associated with this resource. */
customerId?: (Scalars['ID'] | null),
/** Set to true to register an On-Prem Resource only available to Organization users. Only valid for Organization users. */
orgOnly?: (Scalars['Boolean'] | null),
...
export type MutationGenqlSelection = RootMutationGenqlSelection
    ...
    const Node_possibleTypes: string[] = ['OrgTotalUsageMetrics','OrgDailyUsageMetrics','InstanceDailyUsageMetrics','Instance','Customer','Organization','Theme','ThemeColor','ThemeProperty','OrganizationSigningKey','Credential','AuthorizationMethod','CredentialField','User','Role','AuthObjectType','Permission','Integration','InstanceProfile','RequiredConfigVariable','Connection','Component','Action','InputField','Version','ConnectionTemplate','InputFieldTemplate','RequiredConfigVariableCredentialType','Expression','IntegrationFlow','IntegrationAction','InstanceExecutionResult','InstanceFlowConfig','AlertMonitor','AlertTrigger','AlertGroup','AlertWebhook','AlertEvent','Log','InstanceConfigVariable','OnPremiseResource','UserLevelConfigVariable','UserLevelConfig','UserLevelFlowConfig','InstanceStepResult','CustomerTotalUsageMetrics','StarredRecord','ObjectPermissionGrant','ExternalLogStream','Label','IntegrationCategory','ComponentCategory','Activity']
    ...
    const InstanceProfile_possibleTypes: string[] = ['InstanceProfile']
    export const isInstanceProfile = (obj?: { __typename?: any } | null): obj is InstanceProfile => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isInstanceProfile"')
      return InstanceProfile_possibleTypes.includes(obj.__typename)
    }
    ...
    const OnPremiseResource_possibleTypes: string[] = ['OnPremiseResource']
    export const isOnPremiseResource = (obj?: { __typename?: any } | null): obj is OnPremiseResource => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isOnPremiseResource"')
      return OnPremiseResource_possibleTypes.includes(obj.__typename)
    }
    ...
    const OnPremiseResourceConnection_possibleTypes: string[] = ['OnPremiseResourceConnection']
    export const isOnPremiseResourceConnection = (obj?: { __typename?: any } | null): obj is OnPremiseResourceConnection => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isOnPremiseResourceConnection"')
      return OnPremiseResourceConnection_possibleTypes.includes(obj.__typename)
    }
    


    const OnPremiseResourceEdge_possibleTypes: string[] = ['OnPremiseResourceEdge']
    export const isOnPremiseResourceEdge = (obj?: { __typename?: any } | null): obj is OnPremiseResourceEdge => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isOnPremiseResourceEdge"')
      return OnPremiseResourceEdge_possibleTypes.includes(obj.__typename)
    }
    ...
    const InstanceProfileConnection_possibleTypes: string[] = ['InstanceProfileConnection']
    export const isInstanceProfileConnection = (obj?: { __typename?: any } | null): obj is InstanceProfileConnection => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isInstanceProfileConnection"')
      return InstanceProfileConnection_possibleTypes.includes(obj.__typename)
    }
    


    const InstanceProfileEdge_possibleTypes: string[] = ['InstanceProfileEdge']
    export const isInstanceProfileEdge = (obj?: { __typename?: any } | null): obj is InstanceProfileEdge => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isInstanceProfileEdge"')
      return InstanceProfileEdge_possibleTypes.includes(obj.__typename)
    }
    


    const ComponentActionSearchResult_possibleTypes: string[] = ['Component','Action']
    export const isComponentActionSearchResult = (obj?: { __typename?: any } | null): obj is ComponentActionSearchResult => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isComponentActionSearchResult"')
      return ComponentActionSearchResult_possibleTypes.includes(obj.__typename)
    }
    ...
    const FindUserByEmailPayload_possibleTypes: string[] = ['FindUserByEmailPayload']
    export const isFindUserByEmailPayload = (obj?: { __typename?: any } | null): obj is FindUserByEmailPayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isFindUserByEmailPayload"')
      return FindUserByEmailPayload_possibleTypes.includes(obj.__typename)
    }
    


    const FindUserResult_possibleTypes: string[] = ['FindUserResult']
    export const isFindUserResult = (obj?: { __typename?: any } | null): obj is FindUserResult => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isFindUserResult"')
      return FindUserResult_possibleTypes.includes(obj.__typename)
    }
    ...
    const SetOrganizationSalesforceIdPayload_possibleTypes: string[] = ['SetOrganizationSalesforceIdPayload']
    export const isSetOrganizationSalesforceIdPayload = (obj?: { __typename?: any } | null): obj is SetOrganizationSalesforceIdPayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSetOrganizationSalesforceIdPayload"')
      return SetOrganizationSalesforceIdPayload_possibleTypes.includes(obj.__typename)
    }
    ...
    const UpdateUserLevelOAuth2ConnectionPayload_possibleTypes: string[] = ['UpdateUserLevelOAuth2ConnectionPayload']
    export const isUpdateUserLevelOAuth2ConnectionPayload = (obj?: { __typename?: any } | null): obj is UpdateUserLevelOAuth2ConnectionPayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isUpdateUserLevelOAuth2ConnectionPayload"')
      return UpdateUserLevelOAuth2ConnectionPayload_possibleTypes.includes(obj.__typename)
    }
    ...
    const CreateInstanceProfilePayload_possibleTypes: string[] = ['CreateInstanceProfilePayload']
    export const isCreateInstanceProfilePayload = (obj?: { __typename?: any } | null): obj is CreateInstanceProfilePayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isCreateInstanceProfilePayload"')
      return CreateInstanceProfilePayload_possibleTypes.includes(obj.__typename)
    }
    ...
    const DeleteInstanceProfilePayload_possibleTypes: string[] = ['DeleteInstanceProfilePayload']
    export const isDeleteInstanceProfilePayload = (obj?: { __typename?: any } | null): obj is DeleteInstanceProfilePayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isDeleteInstanceProfilePayload"')
      return DeleteInstanceProfilePayload_possibleTypes.includes(obj.__typename)
    }
    ...
    const UpdateInstanceProfilePayload_possibleTypes: string[] = ['UpdateInstanceProfilePayload']
    export const isUpdateInstanceProfilePayload = (obj?: { __typename?: any } | null): obj is UpdateInstanceProfilePayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isUpdateInstanceProfilePayload"')
      return UpdateInstanceProfilePayload_possibleTypes.includes(obj.__typename)
    }
    ...
    const UpdateIntegrationTestConfigurationPayload_possibleTypes: string[] = ['UpdateIntegrationTestConfigurationPayload']
    export const isUpdateIntegrationTestConfigurationPayload = (obj?: { __typename?: any } | null): obj is UpdateIntegrationTestConfigurationPayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isUpdateIntegrationTestConfigurationPayload"')
      return UpdateIntegrationTestConfigurationPayload_possibleTypes.includes(obj.__typename)
    }
    ...
    const CreateOnPremiseResourceJWTPayload_possibleTypes: string[] = ['CreateOnPremiseResourceJWTPayload']
    export const isCreateOnPremiseResourceJWTPayload = (obj?: { __typename?: any } | null): obj is CreateOnPremiseResourceJWTPayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isCreateOnPremiseResourceJWTPayload"')
      return CreateOnPremiseResourceJWTPayload_possibleTypes.includes(obj.__typename)
    }
    


    const CreateOnPremiseResourceJWTResult_possibleTypes: string[] = ['CreateOnPremiseResourceJWTResult']
    export const isCreateOnPremiseResourceJWTResult = (obj?: { __typename?: any } | null): obj is CreateOnPremiseResourceJWTResult => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isCreateOnPremiseResourceJWTResult"')
      return CreateOnPremiseResourceJWTResult_possibleTypes.includes(obj.__typename)
    }
    


    const DeleteOnPremiseResourcePayload_possibleTypes: string[] = ['DeleteOnPremiseResourcePayload']
    export const isDeleteOnPremiseResourcePayload = (obj?: { __typename?: any } | null): obj is DeleteOnPremiseResourcePayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isDeleteOnPremiseResourcePayload"')
      return DeleteOnPremiseResourcePayload_possibleTypes.includes(obj.__typename)
    }
    


    const RotateOnPremiseResourceJWTPayload_possibleTypes: string[] = ['RotateOnPremiseResourceJWTPayload']
    export const isRotateOnPremiseResourceJWTPayload = (obj?: { __typename?: any } | null): obj is RotateOnPremiseResourceJWTPayload => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isRotateOnPremiseResourceJWTPayload"')
      return RotateOnPremiseResourceJWTPayload_possibleTypes.includes(obj.__typename)
    }
...
export const enumRequiredConfigVariableOnPremiseConnectionConfig = {
   REQUIRED: 'REQUIRED' as const,
   ALLOWED: 'ALLOWED' as const,
   DISALLOWED: 'DISALLOWED' as const
}
...
export const enumOnPremiseResourceStatus = {
   PENDING: 'PENDING' as const,
   AVAILABLE: 'AVAILABLE' as const,
...
export const enumOnPremiseResourceOrderField = {
   NAME: 'NAME' as const,
   CUSTOMER: 'CUSTOMER' as const
}
...
export const enumInstanceProfileOrderField = {
   NAME: 'NAME' as const,
   DESCRIPTION: 'DESCRIPTION' as const,
   IS_DEFAULT_PROFILE: 'IS_DEFAULT_PROFILE' as const
}
